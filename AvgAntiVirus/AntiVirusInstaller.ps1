...
Invoke-WebRequest "https://bits.avcdn.net/productfamily_ANTIVIRUS/insttype_FREE/platform_WIN_AVG/installertype_FULL/build_RELEASE/cookie_mmm_bav_003_999_a6k_m"  -OutFile $Installer/$filename; 

Write-Output "AVG Antivirus installer is uitgevoerd"

Start-Process antiVirusSilentInstaller.cmd  
